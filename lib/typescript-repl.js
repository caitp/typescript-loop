"use strict"; (function(window) {
  ...
  function setupDOM() {
    ...
    var compiledDOM = containers[1].querySelector('.CodeMirror');
    ...
    function addErrorWidget(cm) {
      addClass(compiledDOM, 'error');
    }

    function addSuccessWidget(cm) {
      removeClass(compiledDOM, 'error');
    }
